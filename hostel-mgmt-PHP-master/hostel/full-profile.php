...
$mysql_user = "root";
$mysql_password = "1.2.3.4.5.asiedu";
$database = "hostel";
$prefix = "";
$bd = mysqli_connect($mysql_hostname, $mysql_user, $mysql_password) or die("Could not connect database");
mysqli_select_db($database, $bd) or die("Could not select database");
?>
...
<?php 
		 $ret= mysqli_query("SELECT * FROM registration where emailid = '".$_GET['id']."'");
